...
/*function miFuncion()
{
	...
	//salida de consola, se usa para depurar codigo
...
function bucles()
{
	...
	console.log("Inicia bucle decremento\n");
	//decremento
	for(var x = 10; x > 0; --x)
	{
		console.log(x);
